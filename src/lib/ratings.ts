 ...
 *
 * @param rating Raw rating value, which may fall outside 0–5.
 * @returns The rating clamped to the 0–5 range.
 */
 ...
 *
 * @param rating Rating to render, or `null` when the game has no rating yet.
 * @returns A star glyph string, or `'Not yet rated'` when `rating` is `null`.
 */
